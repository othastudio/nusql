...
describe('Nusql Data types', function () {
    ...
    it('should generate a TINYBLOB column type', function () {
        nusql.tinyblob();
        expect(nusql.build()).toBe('TINYBLOB');
    });
    it('should generate a TINYTEXT column type', function () {
        nusql.tinytext();
        expect(nusql.build()).toBe('TINYTEXT');
    });
    it('should generate a TEXT column type with a specified size', function () {
        nusql.text(30);
    ...
    it('should generate a BOOL column type', function () {
        nusql.bool();
        expect(nusql.build()).toBe('BOOL');
    });
    it('should generate a BOOLEAN column type', function () {
        nusql.boolean();
    ...
    it('should generate a FLOAT column type', function () {
        nusql.float();
        expect(nusql.build()).toBe('FLOAT');
    });
    it('should generate a FLOAT column type with size', function () {
        nusql.float(10);
        expect(nusql.build()).toBe('FLOAT(10)');
    });
    it('should generate a FLOAT column type with size and precision', function () {
        nusql.float(10, 2);
        expect(nusql.build()).toBe('FLOAT(10, 2)');
    });
    it('should generate a DOUBLE column type with a specified size and precision', function () {
        nusql.double(15, 3);
        expect(nusql.build()).toBe('DOUBLE(15, 3)');
    });
    it('should generate a DOUBLE PRECISION column type with a specified size and precision', function () {
        nusql.doublePrecision(15, 3);
        expect(nusql.build()).toBe('DOUBLE PRECISION(15, 3)');
    });
    it('should generate a DECIMAL column type with a specified size and precision', function () {
        nusql.decimal(12, 4);
        expect(nusql.build()).toBe('DECIMAL(12, 4)');
    });
    it('should generate a DEC column type with a specified size and precision', function () {
        nusql.dec(12, 4);
    ...
    it('should generate a DATETIME column type', function () {
        nusql.datetime();
    ...
    it('should generate a TIMESTAMP column type', function () {
        nusql.timestamp();
    ...
    it('should generate a TIME column type', function () {
        nusql.time();
